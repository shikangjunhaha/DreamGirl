...
class CustomGizmo extends Editor.Gizmo {
    ...
    getCornerPointsInView(){
        let node = this.node;
        let leftUp = this.getCornerPointInView(cc.v2(-node.width/2,node.height/2));
        let rightUp = this.getCornerPointInView(cc.v2(node.width/2,node.height/2));
        let rightDown = this.getCornerPointInView(cc.v2(node.width/2,-node.height/2));
        let leftDown = this.getCornerPointInView(cc.v2(-node.width/2,-node.height/2));    
